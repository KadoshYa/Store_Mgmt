    ...
    <div style="padding-right:5%; padding-left:5%">
        ...
        <div class="card mx-auto"   style="
                ...
                @endif
                    ...
                    <div class="card-body" >
                        <form action="{{route('order.update', ['id' => $request->id])}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field()}}
                            
                                <div class="form-group">
                                    <label for="order_detail">Update Description</label>
                                    <textarea name="order_detail" id="detail" cols="5" rows="5" class="form-control">{{$request->order_description}}</textarea>                
                                </div>
                                    
                                    <div class="form-group col-sm-4">
                                        <label for="asset_id">Choose Another Asset</label>
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label for="quantity">Change Order Quantitiy</label>
