    ...
    <div style="padding-right:5%; padding-left:5%">
        ...
        <div class="card mx-auto"   style="
                ...
                @endif
                    ...
                    <div class="card-body" >
                        <form action="{{route('asset.categorystore', ['id' => $category->id ])}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field()}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="text" id="total" name="total_price" class="form-control">
                                    </div>
                                </div>
