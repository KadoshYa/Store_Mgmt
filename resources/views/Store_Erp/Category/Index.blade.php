        ...
        <div class="col-md-12" style=" top: 20px; padding-right:20px; padding-left:20px; ">
            <div class="card" >
              ...
              <div class="card-header">
                  <label class="card-title"> All Categories</label>
              </div>
                  <!-- /.card-header -->
                  <!-- Card-Body -->
                <div class="card-body">
                            ...
                            @foreach ($categories as $category)
                                <div class="col-lg-4 col-6"> 
                                  ...
                                  <div class="small-box" style="background-color:{{$category->color}}">
                                      ...
                                      <a href="{{ route ('category.delete', ['id' => $category->id ]) }}"><span class="fa fa-times-circle " style="color:red" title="Trash Project"></a>
                                      </span>
